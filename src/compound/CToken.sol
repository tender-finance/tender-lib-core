...
import "./../external/gmx/IRewardRouterV2.sol";
...
abstract contract CToken is CTokenInterface, ExponentialNoError, TokenErrorReporter {
     ...
     * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details)
     */
    function _setGlpAddresses(address stakedGLP_, address glpRewardRouter_, address glpManager_, address gmxToken_, address stakedGmxTracker_, address sbfGMX_) override public returns (uint) {
        // Check caller is admin
        if (msg.sender != admin) {
